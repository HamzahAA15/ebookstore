...
func (_m *IOrderRepository) CreateItem(ctx context.Context, item model.Item) error {
...
func (_m *IOrderRepository) CreateOrder(ctx context.Context, order model.Order) (uint, error) {
	...
	var r0 uint
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, model.Order) (uint, error)); ok {
		return rf(ctx, order)
	}
	if rf, ok := ret.Get(0).(func(context.Context, model.Order) uint); ok {
		r0 = rf(ctx, order)
	} else {
		r0 = ret.Get(0).(uint)
	}
...
// UpdateOrderByOrderID provides a mock function with given fields: ctx, order
func (_m *IOrderRepository) UpdateOrderByOrderID(ctx context.Context, order model.Order) error {
	ret := _m.Called(ctx, order)
