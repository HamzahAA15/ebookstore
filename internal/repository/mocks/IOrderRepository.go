...
func (_m *IOrderRepository) CreateItem(ctx context.Context, tx *sqlx.Tx, item model.Item) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *sqlx.Tx, model.Item) error); ok {
		r0 = rf(ctx, tx, item)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *IOrderRepository) CreateOrder(ctx context.Context, tx *sqlx.Tx, order model.Order) (uint, error) {
	...
	var r0 uint
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *sqlx.Tx, model.Order) (uint, error)); ok {
		return rf(ctx, tx, order)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *sqlx.Tx, model.Order) uint); ok {
		r0 = rf(ctx, tx, order)
	} else {
		r0 = ret.Get(0).(uint)
	}

	if rf, ok := ret.Get(1).(func(context.Context, *sqlx.Tx, model.Order) error); ok {
		r1 = rf(ctx, tx, order)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *IOrderRepository) UpdateOrderByOrderID(ctx context.Context, tx *sqlx.Tx, order model.Order) error {
	ret := _m.Called(ctx, tx, order)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *sqlx.Tx, model.Order) error); ok {
		r0 = rf(ctx, tx, order)
	} else {
		r0 = ret.Error(0)
	}
