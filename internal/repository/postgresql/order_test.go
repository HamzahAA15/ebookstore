...
// 			mockExpectQuery := m.ExpectQuery(query).WithArgs(tt.args.order.TotalItem, tt.args.order.TotalPrice, tt.args.order.ID)
// 			if tt.fields.err != nil {
// 				mockExpectQuery.WillReturnError(err)
// 			}

// 			err = testDB.UpdateOrderByOrderID(tt.args.ctx, tx, tt.args.order)
// 			assert.Equal(t, tt.wantErr, err != nil)
// 		})
// 	}
// }
...
// 			mockExpectExec := m.ExpectQuery(query).WithArgs(tt.args.item.BookID, tt.args.item.Quantity, tt.args.item.OrderID, tt.args.item.CreatedAt)
// 			if tt.fields.err != nil {
